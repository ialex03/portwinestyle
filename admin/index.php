...
<html>
  <head>
    ...
    <title>PortlineAdmin - Login</title>
            ...
            <div class="col-lg-6">
              <div class="form d-flex align-items-center">
                <div class="content">
                  ...
                  ?>
                  <form method="POST" class="form-validate mb-4" action="verifyadminuser.php">
                    ...
                    <div class="form-group">
                      <input id="login-password" type="password" name="loginPassword" required data-msg="Por favor preencha com a palavra-passe" class="input-material">
                      <label for="login-password" class="label-material">Palavra-passe</label>
                    </div>
                    <button type="submit" class="btn btn-primary">Iniciar sessão</button>
                  </form><a href="recoveradmin.php" class="forgot-pass">Esqueceu-se da palavra-passe?</a><br>
                </div>
              </div>
            </div>
          </div>
