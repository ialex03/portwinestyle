...
$query="SELECT * FROM encomendas  WHERE is_active=1 ORDER BY id";
$arrCamposProdutos=db_query($query);
$arrTabelasIdiomas=array('encomendas'=>array(
                                    'id',
                                    'data_hora',
                                    'is_active'
                                    ));
      ...
      <div id="modalinsert" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
        <div role="document" class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>Aqui pode inserir uma encomenda. Se não quiser inserir nada feche o modal.</p>
