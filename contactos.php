...
<head>
    ...
    <title>Portline - <?php echo $arrLang['contactos'];?></title>
...
<body>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="breadcrumb__text">
                        <h2><?php echo $arrLang['contactos']?></h2>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="breadcrumb__links">
                        <a href="./home.php"><?php echo $arrLang['home']?></a>
                        <span><?php echo $arrLang['contactos']?></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <?php include $arrSETTINGS['dir_site'].'/includes/contactos.inc.php'; ?>
    <!-- Contact Section End -->
