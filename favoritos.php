...
<head>
    ...
    <title>Portline - <?php echo $arrLang['favoritos']?></title>
...
<body>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="breadcrumb__text">
                        <h2><?php echo $arrLang['favoritos']?></h2>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="breadcrumb__links">
                        <a href="./home.php">Home</a>
                        <span><?php echo $arrLang['favoritos']?></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            if ($_GET['success']=="true") {
                ...
                echo'<div class="checkout__input__checkbox">
                        <div class="success">
                            <p>'.$arrLang["order_sucesso"].'</p>
                        </div>
                    </div>';
            }else if($_GET['success']=="false"){
                echo'<div class="checkout__input__checkbox">
                        <div class="warning">
                            <p>'.$arrLang["order_fail"].'</p>
                        </div>
                    </div>';
    ...
    <?php include $arrSETTINGS['dir_site'].'/includes/favoritos.inc.php'; ?>
