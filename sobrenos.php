...
<head>
    ...
    <title>Portline - <?php echo $arrLang['sobre']?></title>
...
<body>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="breadcrumb__text">
                        <h2><?php echo $arrLang['sobre']?></h2>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="breadcrumb__links">
                        <a href="./home.php">Home</a>
                        <span><?php echo $arrLang['sobre']?></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- About Section Begin -->
    <?php include $arrSETTINGS['dir_site'].'/includes/about.inc.php'; ?>
    <!-- About Section End -->
