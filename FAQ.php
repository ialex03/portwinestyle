...
<body>
    ...
    <section class="about spad">
        <div class="container">
            <?php
            $query="SELECT * FROM paginas A INNER JOIN paginas_idiomas B ON A.id=B.id WHERE A.is_active = 1 AND B.idioma='$_SESSION[idioma]' AND A.route='FAQ.php' ORDER BY A.id";
