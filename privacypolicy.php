...
<head>
    ...
    <title>Portline - <?php echo $arrLang['Política de Privacidade'];?></title>
...
<body>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="breadcrumb__text">
                        <h2><?php echo $arrLang['Política de Privacidade'];?></h2>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="breadcrumb__links">
                        <a href="./home.php">Home</a>
                        <span><?php echo $arrLang['Política de Privacidade'];?></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="about spad">
        <div class="container">
            ...
            <?php echo $arrLang['politicatexto'];?>
